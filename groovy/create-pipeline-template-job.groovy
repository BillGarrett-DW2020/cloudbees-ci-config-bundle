...
if (configOpsJob == null) {
  ...
  SCMSource scm = new GitSCMSource("https://github.com/BillGarrett-DW2020/pipeline-template-catalog.git");
      ...
      <instance>
        ...
        <values class="tree-map">
          ...
          <entry>
            ...
            <string>BillGarrett-DW2020</string>
          </entry>
          <entry>
        ...
        <data>
          <jenkins.branch.BranchSource>
            <source class="org.jenkinsci.plugins.github_branch_source.GitHubSCMSource" plugin="github-branch-source@2.8.3">
              ...
              <repoOwner>BillGarrett-DW2020</repoOwner>
              <repository>pipeline-template-catalog</repository>
              <repositoryUrl>https://github.com/BillGarrett-DW2020/pipeline-template-catalog.git</repositoryUrl>
              <traits>
